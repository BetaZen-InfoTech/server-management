...
- **Deploy Software** — GitHub-integrated project runner with framework presets (Next.js, Nuxt, NestJS, static, Node API, Python, Go), per-service systemd units, and auto-reconciling nginx vhosts.
