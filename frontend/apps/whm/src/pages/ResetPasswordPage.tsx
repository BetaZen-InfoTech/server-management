...
// sends. Expects ?token=<hex>. POSTs to /auth/reset-password with the
// token + new password; on success the user is redirected to the
// login page with a confirmation toast.
