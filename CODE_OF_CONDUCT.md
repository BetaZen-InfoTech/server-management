...
This Code of Conduct applies within all community spaces — the GitHub repository (issues, pull requests, discussions), any official chat channel, email, video calls, and in-person events — and also applies when an individual is officially representing the community in public spaces.

---

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the project maintainers at **conduct@betazeninfotech.com**. All complaints will be reviewed and investigated promptly and fairly.
